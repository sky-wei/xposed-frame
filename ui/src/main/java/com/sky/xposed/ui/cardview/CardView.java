...
//        }
        ...
        mPreventCornerOverlap = true;   // a.getBoolean(R.styleable.CardView_cardPreventCornerOverlap, true);
        int defaultPadding = 0; // a.getDimensionPixelSize(R.styleable.CardView_contentPadding, 0);
        mContentPadding.left = defaultPadding;  // a.getDimensionPixelSize(R.styleable.CardView_contentPaddingLeft,defaultPadding);
        mContentPadding.top = defaultPadding;   // a.getDimensionPixelSize(R.styleable.CardView_contentPaddingTop, defaultPadding);
        mContentPadding.right = defaultPadding; // a.getDimensionPixelSize(R.styleable.CardView_contentPaddingRight, defaultPadding);
        mContentPadding.bottom = defaultPadding;    // a.getDimensionPixelSize(R.styleable.CardView_contentPaddingBottom, defaultPadding);
//        if (elevation > maxElevation) {
//            maxElevation = elevation;
//        }

        mUserSetMinWidth = 0;   // a.getDimensionPixelSize(R.styleable.CardView_android_minWidth, 0);
        mUserSetMinHeight = 0;  // a.getDimensionPixelSize(R.styleable.CardView_android_minHeight, 0);
//        a.recycle();

        IMPL.initialize(mCardViewDelegate, context, ColorStateList.valueOf(Color.WHITE), radius,
